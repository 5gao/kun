$(function () {
  ...
  QUnit.test('should user tooltips relative to placement option', function (assert) {
    assert.expect(2)
  ...
  QUnit.test('should user tooltips inside body when container is body', function (assert) {
    assert.expect(3)
    var $tooltip = $('<a href="#" rel="tooltip" title="Another tooltip"/>')
      .appendTo('#qunit-fixture')
  ...
  QUnit.test('should user tooltip on top of element', function (assert) {
    assert.expect(1)
    var done = assert.async()
  ...
  QUnit.test('should user tooltip inside viewport', function (assert) {
    assert.expect(1)
    var done = assert.async()
